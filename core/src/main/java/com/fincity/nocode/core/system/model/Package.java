...
public class Package implements Serializable {
	...
	public static final Schema SCHEMA = new Schema().setType(new SingleType(OBJECT))
			...
			.setProperties(
					Map.of("id", Schema.of("id", STRING), "packageName", Schema.of("packageName", SchemaType.STRING),
							"namespace", Schema.of("namespace", SchemaType.STRING),
							"packageObjectName", Schema.of("packageObjectName", SchemaType.STRING),
							"objectName", Schema.of("objectName", SchemaType.STRING)
							));
	...
	public static final Store STORE_RECORD = new Store().setAudited(true).setVersioned(true).setSoftDelete(true)
			...
			.setWritePermission(CoreConstants.PERMISSION_ADMIN).setUpdatePermission(CoreConstants.PERMISSION_ADMIN)
